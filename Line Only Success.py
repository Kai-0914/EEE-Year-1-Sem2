            ...
            if contours:
                ...
                if M["m00"] != 0:
                    ...
                    if abs(error) < 20:
                        ...
                        if cy > 280 and cy < 340:
                            adjustment = 1.25 * error
                            left_speed = (base_speed - 15) - adjustment
                            right_speed = (base_speed - 15) + adjustment
                            left_speed = max(0, min(100, left_speed))
                            right_speed = max(0, min(100, right_speed))
                            pwmA.ChangeDutyCycle(left_speed)
                            pwmB.ChangeDutyCycle(right_speed)
                        ...
                        #print(f"Left Motor: {left_speed:.1f}%, Right Motor: {right_speed:.1f}%")
